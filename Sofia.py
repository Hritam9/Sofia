...
def assistant(command):
    ...
    if 'shutdown' in command:
        sofiaResponse('Bye Sir. Have a nice day!')
        sys.exit()
...
#current weather
        ...
        if reg_ex:
            city = reg_ex.group(1)
            owm = OWM(API_key='04fce476388954330421f919d43013c4')
...
sofiaResponse('Hi Ritam, I am Sofia and I am your personal voice assistant, Please give a command or say "help me" and I will tell you what all I can do for you.')
